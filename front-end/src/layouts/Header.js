...
const Header = () => {
    ...
    return (
        <div>
            {!user ? <></> : <>
                <Navbar className='bg-primary navbar-dark fixed-top p-0'>
                    ...
                    <Collapse className="navbar-collapse" isOpen={isOpen} navbar>
                        <Nav className="me-auto mb-2 mb-lg-0 justify-content-end" style={{ width: "100%" }} navbar>
                            <NavItem className="dropdown">
                                <NavLink className='App-link dropdown-toggle' role="button" data-bs-toggle="dropdown"
                            ...
                            <NavItem>
                                <NavLink className='App-link' href="/user/info">Thông tin tài khoản</NavLink>
                            </NavItem>
                            <NavItem>
                                <NavLink className='App-link' href="#" onClick={signout}>Đăng xuất</NavLink>
                            </NavItem>
                        </Nav>
                    </Collapse>
                </Navbar>
