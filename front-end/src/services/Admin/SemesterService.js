...
class SemesterService {
    getAvailableSemester() { return axios.get(SEMESTER_API_ADMIN_URL + '/getavailable', config); }
    getSemesterById(id) { return axios.get(SEMESTER_API_ADMIN_URL + '/get/' + id, config); }
